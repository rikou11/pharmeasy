...
<body style="font-family: Inter">
    ...
    <div class="container ">
        <h2 style="margin-top: 50px; color : green;"><i class="fas fa-list"></i>Validation</h1>
...
<div class="modal-dialog modal-dialog-centered" role="document">
 ...
 <a href="liste-validation.php?delete=' . $id . '&fullname=' . $fullname . '&email=' . $email . '&telrevendeur=' . $numero . ' &emailrevendeur=' . $valider_par . ' "class="btn btn-primary btn" "> supprimer client</a>
