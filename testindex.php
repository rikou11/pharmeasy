                ...
                <div class="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
                    <div class="max-w-xl mb-6">
                        ...
                        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                            Lorem ipsum dolor sit.<br class="hidden md:block" />
                            Lorem
                            <span class="inline-block text-deep-purple-accent-400">, ipsum.</span>
                        </h2>
                    ...
                    <!-- <form action="continue/continuemessage.php" method="POST"> -->
                    <div class="flex flex-col md:space-x-2 md:flex-row">
                        <input type="email" class="block w-full px-4   py-4 md:py-2 mt-2 text-xl md:text placeholder-gray-400 bg-gray-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50" placeholder="Entrer votre Email">
                        <input type="text" class="block w-full px-4  py-4 md:py-2 mt-2 text-xl md:text placeholder-gray-400 bg-gray-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50" placeholder="Entrer votre message">
            ...
            <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="relative flex flex-col items-center justify-center w-full h-full px-10 my-20 lg:px-16 lg:my-0">
                        <div class="flex flex-col items-start space-y-8 tracking-tight lg:max-w-3xl">
                            <div class="relative">
                                ...
                                <h2 class="text-5xl font-bold text-gray-900 xl:text-6xl">Lorem ipsum dolor sit amet
                                    consectetur.</h2>
                            </div>
                            <p class="text-2xl text-gray-700">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                Mollitia doloribus hic illum cum iste voluptatem tempora explicabo iusto eius voluptate.
                            </p>
                ...
                <div class="w-full bg-white lg:w-6/12 xl:w-5/12">
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="flex flex-col items-start justify-start w-full h-full p-10 lg:p-16 xl:p-24" id="valider">
                        <h4 class="w-full text-3xl font-bold">Valider la commande</h4>
    ...
    <section>
        ...
        <div x-data="{}" class="px-5">
            ...
            <div class=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center gap-5 ">
                <div class=" px-2">
                    <div class="rounded  ">
                        <a @click="$dispatch('img-modal', {  imgModalSrc: 'https://dummyimage.com/600x360', imgModalDesc: 'Random Image One Description' })" class="cursor-pointer">
                            <img alt="Placeholder" class="object-fit w-full rounded-lg" src="https://dummyimage.com/600x360">
                        </a>
                    </div>
                </div>
                ...
                <div class=" px-2">
                    <div class="rounded ">
                        <a @click="$dispatch('img-modal', {  imgModalSrc: 'https://dummyimage.com/600x360', imgModalDesc: '' })" class="cursor-pointer">
                            <img alt="Placeholder" class="object-fit w-full rounded-lg" src="https://dummyimage.com/600x360">
                        </a>
                    </div>
                </div>
                ...
                <div class=" px-2">
                    <div class="rounded ">
                        <a @click="$dispatch('img-modal', {  imgModalSrc: 'https://dummyimage.com/600x360', imgModalDesc: 'This one has description' })" class="cursor-pointer">
                            <img alt="Placeholder" class="object-fit w-full rounded-lg" src="https://dummyimage.com/600x360">
                        </a>
                    </div>
                </div>
