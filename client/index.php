<?php include('validation/login-client.php') ?>
    ...
    <section>
        <div class="flex flex-col justify-center py-12 sm:px-6 lg:px-8" style="height: 700px;">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <h2 class="mt-6 text-2xl font-extrabold text-center text-neutral-600"> Connecter vous pour commencer le téléchargement </h2>
            </div>
                ...
                <div class="px-4 py-8 sm:px-10">
                    <form class="space-y-6" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="password" value="" name="password" type="text" autocomplete="current-password" placeholder="" required="" class="
                      block
                      w-full
                      px-5
                      py-3
                    ...
                    focus:ring-blue-500
                    shadow-lg
                  "> Connnexion &nbsp;&nbsp;<i class="fa-solid fa-arrow-right-to-bracket"></i> </button>
                        </div>
                    </form>
                </div>
            </div>
